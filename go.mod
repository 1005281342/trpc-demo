module github.com/1005281342/trpc-demo

go 1.18

replace github.com/1005281342/trpc-demo/helloworld => ./stub/github.com/1005281342/trpc-demo/helloworld

require (
	github.com/1005281342/trpc-demo/helloworld v0.0.0-00010101000000-000000000000
