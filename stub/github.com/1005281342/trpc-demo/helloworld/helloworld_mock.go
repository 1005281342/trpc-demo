...
func (m *MockHelloWorldServiceService) SayHi(ctx context.Context, req *SayHiReq) (*SayHiRsp, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SayHi", ctx, req)
	ret0, _ := ret[0].(*SayHiRsp)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// SayHi indicates an expected call of SayHi.
func (mr *MockHelloWorldServiceServiceMockRecorder) SayHi(ctx, req interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SayHi", reflect.TypeOf((*MockHelloWorldServiceService)(nil).SayHi), ctx, req)
}
...
// SayHi mocks base method.
func (m *MockHelloWorldServiceClientProxy) SayHi(ctx context.Context, req *SayHiReq, opts ...client.Option) (*SayHiRsp, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, req}
	for _, a := range opts {
		varargs = append(varargs, a)
...
// SayHi indicates an expected call of SayHi.
func (mr *MockHelloWorldServiceClientProxyMockRecorder) SayHi(ctx, req interface{}, opts ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, req}, opts...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SayHi", reflect.TypeOf((*MockHelloWorldServiceClientProxy)(nil).SayHi), varargs...)
}
